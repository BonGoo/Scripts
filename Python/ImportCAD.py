...
def select_csv_file():
    ...
    if file_path:
        ...
        with open(file_path, 'r', newline='', encoding='utf-8') as f:
            ...
            xml += f'<DANE_CAD UZYTKOWNIK="Przemysław Gawlik">\n'
...
creator_label = tk.Label(window, text="Created by Rafał Biel == Watermark: Przemysław Gawlik", relief=tk.SUNKEN, anchor=tk.W)
